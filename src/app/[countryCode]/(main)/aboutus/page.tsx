...
//       {/* Our Approach Section with Combined Image and Content */}
...
//           <Heading level="h3" className="text-lg font-semibold mt-4">Why the Falcon?</Heading>
//           <p className="text-base md:text-lg text-gray-700">
//             We cultivate adaptability and innovativeness, encouraging our members to embrace change.
//           </p>
//           <Heading level="h3" className="text-lg font-semibold mt-4">Incorporation of Spirituality</Heading>
...
import AboutUsLarge from './aboutuslarge';
...
const AboutUs = () => {
  ...
  return isMobile ? <AboutUsMobile /> : <AboutUsLarge />;
};
