...
const DesktopCarousel = () => {
  ...
  return (
    <div
      className="relative overflow-hidden h-[500px] w-full bg-transparent"
    ...
    >
      ...
      >
        {pages.map((page, index) => (
          ...
          >
            <h2 className="text-center text-2xl mb-4">{page.title}</h2>
            <p className="text-center text-lg">{page.content}</p>
          </div>
        ))}
      </div>
